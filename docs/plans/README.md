...
| **06** | [`06-architecture-review.html`](06-architecture-review.html) | **Review** | 🟡 Active | Full codebase review: layer map, inventory, twelve findings with closing checks, risks, open questions. |
