...
- [ ] ADR records the centered card geometry plus outside registry stacking plus the alternatives passed over
- [ ] Glossary defines dashboard plus settings window plus quick panel mirror plus Spotify Connect device switch meaning
- [ ] Docs use sentence case with plain words per repo writing rules
